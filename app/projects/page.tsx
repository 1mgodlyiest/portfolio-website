...
// Use the same projects array as in components/sections/projects-section.tsx
...
const projects = [
  ...
  // Case Studies Projects
  {
    ...
    description: "Development of a credit scoring model using machine learning techniques",
  ...
  },
  {
    ...
    description: "Analysis of suburb-level trends in Sydney's property market",
    image: "/images/sydney.jpg",
    category: "case",
    tags: ["Data Visualization", "Real Estate", "Market Analysis"],
    year: "2023",
    link: "https://www.linkedin.com/pulse/sydney-housing-market-dynamics-analyzing-suburb-level-manish-paneru-g7v0f",
    extendedDescription:
      "This case study analyzes suburb-level trends in Sydney's property market to identify key price drivers, neighborhood-specific trends, and cyclical patterns. The analysis incorporates economic indicators, demographic shifts, policy changes, and infrastructure developments to create a comprehensive model of market dynamics that accurately predicted price movements within 4.3% over a subsequent 18-month period.",
  },
  {
    id: 30,
      ...
      <main className="pt-24 pb-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tighter mb-4">Data Analysis Projects</h1>
            <p className="text-muted-foreground max-w-2xl">
              A comprehensive collection of my work across SQL, Python, ETL, Machine Learning, and AI, showcasing my
